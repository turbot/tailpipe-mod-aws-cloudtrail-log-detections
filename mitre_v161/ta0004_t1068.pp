locals {
  mitre_v161_ta0004_t1068_common_tags = merge(local.mitre_v161_ta0004_common_tags, {
...
benchmark "mitre_v161_ta0004_t1068" {
  ...
  type          = "detection"
  documentation = file("./mitre_v161/docs/ta0004_t1068.md")
  children = [
    detection.cloudtrail_logs_detect_vpc_security_group_ingress_egress_updates,
  ]

  tags = local.mitre_v161_ta0004_t1068_common_tags
}
