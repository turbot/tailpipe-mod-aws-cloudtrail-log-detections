...
detection "detect_public_access_granted_to_rds_db_instances" {
  ...
  documentation   = file("./detections/docs/detect_public_access_granted_to_rds_db_instances.md")
  severity        = "medium"
...
detection "detect_rds_db_instance_master_password_updates" {
  ...
  documentation   = file("./detections/docs/detect_rds_db_instance_master_password_updates.md")
  severity        = "low"
  display_columns = local.detection_display_columns
...
detection "detect_rds_db_instances_public_restore" {
  title           = "Detect RDS DB Instances Public Restore"
  ...
  documentation   = file("./detections/docs/detect_rds_db_instances_public_restore.md")
  severity        = "high"
  display_columns = local.detection_display_columns
...
detection "detect_rds_db_clusters_with_deletion_protection_disabled" {
  ...
  documentation   = file("./detections/docs/detect_rds_db_clusters_with_deletion_protection_disabled.md")
  severity        = "medium"
  display_columns = local.detection_display_columns
...
detection "detect_rds_db_instances_with_deletion_protection_disabled" {
  ...
  documentation   = file("./detections/docs/detect_rds_db_instances_with_deletion_protection_disabled.md")
  severity        = "medium"
  display_columns = local.detection_display_columns
