locals {
  mitre_v161_ta0001_t1566_common_tags = merge(local.mitre_v161_ta0001_common_tags, {
    mitre_technique_id = "T1566"
  })
}

benchmark "mitre_v161_ta0001_t1566" {
  title         = "T1566 Phishing"
  type          = "detection"
  documentation = file("./mitre_v161/docs/ta0001_t1566.md")
  children = [
  ...
  tags = local.mitre_v161_ta0001_t1566_common_tags
}
