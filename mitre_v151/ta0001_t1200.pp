locals {
  mitre_v151_ta0001_t1200_common_tags = merge(local.mitre_v151_ta0001_common_tags, {
...
benchmark "mitre_v151_ta0001_t1200" {
  ...
  type          = "detection"
  # documentation = file("./mitre_v151/docs/ta0001_t1200.md")
  children = [
  ...
  tags = local.mitre_v151_ta0001_t1200_common_tags
}
