locals {
  mitre_v151_ta0001_t1189_common_tags = merge(local.mitre_v151_ta0001_common_tags, {
...
benchmark "mitre_v151_ta0001_t1189" {
  ...
  type          = "detection"
  # documentation = file("./mitre_v151/docs/ta0001_t1189.md")
  children = [
  ...
  tags = local.mitre_v151_ta0001_t1189_common_tags
}
