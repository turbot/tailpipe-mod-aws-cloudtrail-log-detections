locals {
  mitre_v161_ta0001_t1195_common_tags = merge(local.mitre_v161_ta0001_common_tags, {
    mitre_technique_id = "T1195"
  })
}

benchmark "mitre_v161_ta0001_t1195" {
  title         = "T1195 Supply Chain Compromise"
  type          = "detection"
  # documentation = file("./mitre_v161/docs/ta0001_t1195.md")
  children = [
  ...
  tags = local.mitre_v161_ta0001_t1195_common_tags
}
