...
locals {
  ...
  detection_sql_resource_column_request_parameters_cloudfront_name                   = replace(local.detection_sql_columns, "__RESOURCE_SQL__", "request_parameters ->> 'name'")
  detection_sql_resource_column_request_parameters_cloudtrail_name                   = replace(local.detection_sql_columns, "__RESOURCE_SQL__", "request_parameters ->> 'name'")
  ...
  detection_sql_resource_column_request_parameters_eventbridge_rule_name             = replace(local.detection_sql_columns, "__RESOURCE_SQL__", "request_parameters ->> 'name'")
