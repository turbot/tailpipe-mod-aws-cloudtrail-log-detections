locals {
  mitre_v151_ta0010_t1539_common_tags = merge(local.mitre_v151_ta0010_common_tags, {
...
benchmark "mitre_v151_ta0010_t1539" {
  title         = "T1539 Steal Web Session Cookie"
  type          = "detection"
  # documentation = file("./mitre_v151/docs/ta0010_t1539.md")
  children = [
    detection.cloudtrail_logs_detect_web_session_cookie_exfiltration
  ]

  tags = local.mitre_v151_ta0010_t1539_common_tags
}
